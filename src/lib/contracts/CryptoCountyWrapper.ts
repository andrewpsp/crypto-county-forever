...
import * as CountySClass from '../../../build/contracts/CryptoCounty.json';
import { CryptoCounty } from '../../types/CryptoCounty';

const DEFAULT_SEND_OPTIONS = {
    gas: 6000000
};

export class CryptoCountyWrapper {
    web3: Web3;

    contract: CryptoCounty;

    address: string;

    constructor(web3: Web3) {
        this.web3 = web3;
        this.contract = new web3.eth.Contract(CountySClass.abi as any) as any;
    }
